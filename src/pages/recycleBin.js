...
const RECYCLE_CONFIG = [
  ...
  { key: 'permits', label: 'Permit', listDeleted: listDeletedPermits, restore: restorePermit, purge: permanentlyDeletePermit, displayFn: (r) => r.title || r.location || 'Permit', cacheKeys: ['permits'] },
